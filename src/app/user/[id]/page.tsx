...
export default function UserHome({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div style={{ minHeight: '100vh', padding: '48px 24px 80px' }}>
      <div style={{ textAlign: 'center', marginBottom: '48px' }}>
        <a href="/" style={{ color: '#8888a0', fontSize: '13px', textDecoration: 'none', marginBottom: '12px', display: 'inline-block' }}>← 返回</a>
        <h1 style={{
      ...
      <div style={{
        ...
        {modules.map((mod, index) => (
          <a
            key={mod.id}
            href={`/user/${userId}/module/${mod.id}`}
      ...
      <div style={{
        ...
        <a href={`/user/${userId}/upload`} style={{
